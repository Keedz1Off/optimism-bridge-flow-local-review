...
`_initiateBridgeERC20(...)` contains the core L1 -> L2 ERC20 deposit logic.
...
This transfers canonical tokens into the bridge and increases the bridge deposit accounting.
